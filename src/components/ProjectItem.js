...
function ProjectItem({project}) {
  ...
  return (
    <div className='project-item d-flex flex-column flex-md-row row justify-content-around align-items-center' onClick={()=>window.open(project.code_link, '_blank')}>
        <motion.div className='col-xl-3 col-10 col-md-6'
        ...
        <motion.div className='d-flex flex-column col-xl-9 col-md-6 col-10'
